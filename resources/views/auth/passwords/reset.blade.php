    ...
    <div class="d-flex flex-column flex-column-fluid flex-lg-row">
        ...
        <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
            ...
            <div class="d-flex flex-column">
                ...
                <h2 class="text-dark fw-normal m-0 justify-content-center">Llene este formulario para restablecer su contraseña</h2>
                <!--end::Title-->
            </div>
            <!--begin::Aside-->
        </div>
                ...
                <div class="card-body p-10 p-lg-20">
                    ...
                    <form class="form w-100" method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <input id="email" type="password" placeholder="Contraseña" name="password" autocomplete="off" class="form-control bg-transparent" />
                            <!--end::Email-->
                        </div>
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <input id="email" type="password" placeholder="Contraseña" name="password_confirmation" autocomplete="off" class="form-control bg-transparent" />
                            <!--end::Email-->
                        </div>

                        <!--begin::Submit button-->
                        <div class="d-grid mb-10">
                            <button type="submit" class="btn  text-uppercase" style="background-color: #013832; color: white">Restablecer contraseña</button>
                        </div>
                        <!--end::Submit button-->
                    </form>
                    <!--end::Form-->
