                ...
                @else
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('client_brands') }}" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            ...
                            <span class="menu-title">Calcula el precio de tu seguro</span>
                        </a>
                    </div>
                    <div class="menu-item">
                        <a class="menu-link" href="https://gepetrol-seguros.com/quienes-somos/nuestra-historia/" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                    <span class="svg-icon svg-icon-2">
