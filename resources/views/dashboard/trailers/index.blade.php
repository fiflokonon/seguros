...
@section('title', 'Tipos de Remolque')
@section('content')
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        @if( $trailer->status)
                                                            <a class="menu-link px-3" href="{{ route('deactivate_trailer', ['id' => $trailer->id]) }}"><i class="fa fa-trash text-danger"></i> Desactivar</a>
                                                        @else
                                                            <a class="menu-link px-3" href="{{ route('activate_trailer', ['id' => $trailer->id]) }}"><i class="fa fa-check text-success"></i> Activar</a>
                                                        @endif
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <!--begin::Form-->
                        <form id="kt_modal_add_user_form" class="form" method="POST" action="{{ route('add_trailer') }}">
                            @csrf
                            <!--begin::Scroll-->
                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Insertar el tipo de remolque" value="{{ old('title') }}" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
